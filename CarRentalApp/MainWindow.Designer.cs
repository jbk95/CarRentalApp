namespace CarRentalApp
{
	partial class MainWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.manageVehicleListingToolStripMenuItem.Click += new System.EventHandler(this.manage);
			// 
			...
			this.ShowIcon = false;
			this.Text = "Testarsk Car Rental Management System";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.MainWindow_FormClosing);
			this.Load += new System.EventHandler(this.MainWindow_Load);
			this.Click += new System.EventHandler(this.addRentalRecordToolStripMenuItem_Click);
